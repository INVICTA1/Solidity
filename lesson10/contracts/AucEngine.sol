...
contract AucEngine {
    address public owner;//The owner of the application, receives a commission
    uint constant DURATION = 2 days;// How long will the auction last
    // immutable - can set value in constructor, not now
    uint constant FEE = 10; // 10% commission
